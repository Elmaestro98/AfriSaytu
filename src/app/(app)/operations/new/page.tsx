...
export default async function NewOperationPage({ searchParams }: PageProps<"/operations/new">) {
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      {usable.length > 1 && (
        <nav aria-label="Point de vente" className="mx-auto flex w-full max-w-md gap-2 overflow-x-auto px-4 pt-4">
          {usable.map((item) => (
      ...
      {branch ? (
        ...
        <main className="mx-auto flex w-full max-w-md flex-1 flex-col gap-3 px-4 py-10 text-center">
